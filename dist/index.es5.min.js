...
/*!**************************!*\
  !*** ./out-es5/rules.js ***!
  \**************************/
/*! no static exports found */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var r=/^[0-9]+$/,o=/^\-?[0-9]*\.?[0-9]+$/,i=/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,u=/^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i,l=/^((http|https):\/\/(\w+:{0,1}\w*@)?(\S+)|)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,a=/^1[34578]\d{9}$/,s=/\d{4}-\d{1,2}-\d{1,2}/,c="%s不能为空",f="%s与%s不匹配",d="%s和%s必须相同",m="%s至少包含%s个字符",h="The %s field must contain a number greater than %s.",v="The %s field must contain a number less than %s.",y="请数入数字",p="The %s field must contain a valid IP.",E="The %s field must contain a valid URL.",b="请输入正确的手机号码",g="请输入正确制";function k(e,t){return{validate:e,error:t}}function w(e){return"function"==typeof e?e():e}function x(e,t){var n;return(n="number"==typeof t?o.test(e)?parseFloat(e):null:"string"==typeof t?e:function(e){if(!e.match("today")&&!e.match(s))return null;var t,n=new Date;e.match("today")||(t=e.split("-"),n.setFullYear(t[0]),n.setMonth(t[1]-1),n.setDate(t[2]));return n}(e))<t?"lessThan":n>t?"greaterThan":"equal"}t.rules={required:function(e){return k(function(e){return""!=e},e||c)},matches:function(e,t){return k(function(t){return t==e.value},t||c)},email:function(e){return k(function(e){return i.test(e)},e||c)},minLength:function(e,t){return k(function(t){return(t||"").length>=w(e)},t||m)},maxLength:function(e,t){return k(function(t){return(t||"").length<=w(e)},t||f)},greaterThan:function(e,t){return k(function(t){return"greaterThan"==x(t,w(e))},t||h)},lessThan:function(e,t){return k(function(t){return"lessThan"==x(t,w(e))},t||v)},equal:function(e,t){return k(function(t){return"equal"==x(t,w(e))},t||d)},ip:function(e){return k(function(e){return u.test(e)},e||p)},url:function(e){return k(function(e){return l.test(e)},e||E)},mobile:function(e){return k(function(e){return a.test(e)},e||b)},numeric:function(e){return k(function(e){return r.test(e)},e||y)},custom:function(e,t){return k(e,t||g)}}}})});
