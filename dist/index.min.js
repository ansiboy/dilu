...
/*!**********************!*\
  !*** ./out/rules.js ***!
  \**********************/
/*! no static exports found */function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=/^[0-9]+$/,l=/^\-?[0-9]*\.?[0-9]+$/,i=/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,o=/^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i,s=/^((http|https):\/\/(\w+:{0,1}\w*@)?(\S+)|)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,a=/^1[34578]\d{9}$/,u=/\d{4}-\d{1,2}-\d{1,2}/;let f="%s不能为空",d="%s与%s不匹配",c="%s和%s必须相同",h="%s至少包含%s个字符",m="The %s field must contain a number greater than %s.",p="The %s field must contain a number less than %s.",y="请数入数字",E="The %s field must contain a valid IP.",v="The %s field must contain a valid URL.",g="请输入正确的手机号码",b="请输入正确制";function w(e,t){return{validate:e,error:t}}function x(e){return"function"==typeof e?e():e}function j(e,t){let r;return(r="number"==typeof t?l.test(e)?parseFloat(e):null:"string"==typeof t?e:function(e){if(!e.match("today")&&!e.match(u))return null;var t,r=new Date;e.match("today")||(t=e.split("-"),r.setFullYear(t[0]),r.setMonth(t[1]-1),r.setDate(t[2]));return r}(e))<t?"lessThan":r>t?"greaterThan":"equal"}t.rules={required:e=>w(e=>""!=e,e||f),matches:(e,t)=>w(t=>t==e.value,t||f),email:e=>w(e=>i.test(e),e||f),minLength:(e,t)=>w(t=>(t||"").length>=x(e),t||h),maxLength:(e,t)=>w(t=>(t||"").length<=x(e),t||d),greaterThan:(e,t)=>w(t=>"greaterThan"==j(t,x(e)),t||m),lessThan:(e,t)=>w(t=>"lessThan"==j(t,x(e)),t||p),equal:(e,t)=>w(t=>"equal"==j(t,x(e)),t||c),ip:e=>w(e=>o.test(e),e||E),url:e=>w(e=>s.test(e),e||v),mobile:e=>w(e=>a.test(e),e||g),numeric:e=>w(e=>n.test(e),e||y),custom:(e,t)=>w(e,t||b)}}})});
