...
/*!**********************!*\
  !*** ./out/rules.js ***!
  \**********************/
/*! no static exports found */function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const n=r(/*! ./formValidator */"./out/formValidator.js");var l=/^[0-9]+$/,i=/^\-?[0-9]*\.?[0-9]+$/,o=/^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,s=/^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i,a=/^((http|https):\/\/(\w+:{0,1}\w*@)?(\S+)|)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,u=/^1[34578]\d{9}$/,f=/\d{4}-\d{1,2}-\d{1,2}/;let d="%s不能为空",h="%s与%s不匹配",m="%s和%s必须相同",c="%s至少包含%s个字符",E="The %s field must contain a number greater than %s.",p="The %s field must contain a number less than %s.",y="请数入数字",v="The %s field must contain a valid IP.",g="The %s field must contain a valid URL.",b="请输入正确的手机号码",w="请输入正确制";function j(e,t){return{validate:e,error:t}}function x(e){return"function"==typeof e?e():e}function A(e,t){let r;return(r="number"==typeof t?i.test(e)?parseFloat(e):null:"string"==typeof t?e:function(e){if(!e.match("today")&&!e.match(f))return null;var t,r=new Date;e.match("today")||(t=e.split("-"),r.setFullYear(t[0]),r.setMonth(t[1]-1),r.setDate(t[2]));return r}(e))<t?"lessThan":r>t?"greaterThan":"equal"}t.rules={required:e=>j(e=>""!=e,e||d),matches:(e,t)=>j(t=>t==n.FormValidator.elementValue(e),t||d),email:e=>j(e=>o.test(e),e||d),minLength:(e,t)=>j(t=>(t||"").length>=x(e),t||c),maxLength:(e,t)=>j(t=>(t||"").length<=x(e),t||h),greaterThan:(e,t)=>j(t=>"greaterThan"==A(t,x(e)),t||E),lessThan:(e,t)=>j(t=>"lessThan"==A(t,x(e)),t||p),equal:(e,t)=>j(t=>"equal"==A(t,x(e)),t||m),ip:e=>j(e=>s.test(e),e||v),url:e=>j(e=>a.test(e),e||g),mobile:e=>j(e=>u.test(e),e||b),numeric:e=>j(e=>l.test(e),e||y),custom:(e,t)=>j(e,t||w)}}});
